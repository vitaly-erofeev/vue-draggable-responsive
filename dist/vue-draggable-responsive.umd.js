(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-draggable-responsive"] = factory(require("vue"));
	else
		root["vue-draggable-responsive"] = factory(root["Vue"]);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StickyToType; });
var StickyToType;

(function (StickyToType) {
  StickyToType["TOP"] = "top";
  StickyToType["RIGHT"] = "right";
  StickyToType["BOTTOM"] = "bottom";
  StickyToType["LEFT"] = "left";
})(StickyToType || (StickyToType = {}));
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "a", function() { return /* binding */ BlockRepository_BlockRepository; });
...
// CONCATENATED MODULE: ./src/infrastructure/service/GuidGenerator.ts
...
var GuidGenerator_GuidGenerator = /*#__PURE__*/function () {
  function GuidGenerator() {
    Object(classCallCheck["a" /* default */])(this, GuidGenerator);
  }

  Object(createClass["a" /* default */])(GuidGenerator, null, [{
    key: "generate",
...
var BlockRepository_BlockRepository = /*#__PURE__*/function () {
  ...
  Object(createClass["a" /* default */])(BlockRepository, [{
    key: "set",
    value: function set(blocks) {
      this.resetActiveBlock();
      this.blocks = this.prepareBlocks(blocks);
    }
  }, {
    key: "prepareBlocks",
    value: function prepareBlocks(blocks) {
      var _this = this;
    ...
    value: function getByGuid(guid) {
      ...
      JSON.stringify(this.blocks, function (_, nestedValue) {
        if (nestedValue && nestedValue.guid === guid && typeof nestedValue.sticky !== 'undefined') {
          answer = nestedValue;
        }
    ...
    value: function add(block) {
      ...
      if (block.parentGuid) {
        ...
        if (typeof parent !== 'undefined') {
          var _parent$tabs, _parent$tabs2;

          if ((_parent$tabs = parent.tabs) !== null && _parent$tabs !== void 0 && _parent$tabs.use && (_parent$tabs2 = parent.tabs) !== null && _parent$tabs2 !== void 0 && _parent$tabs2.activeGuid) {
            block.parentTabGuid = parent.tabs.activeGuid;
          }

          parent.children.push(new BlockDTO["a" /* default */](block));
        }
      } else {
        this.blocks.push(new BlockDTO["a" /* default */](block));
      }
    ...
    value: function remove(guid) {
      ...
      if (block.parentGuid) {
        var parent = this.getByGuid(block.parentGuid);
    ...
    key: "resetActiveBlock",
    value: function resetActiveBlock() {
      JSON.stringify(this.blocks, function (_, nestedValue) {
    ...
    key: "setActiveBlock",
    value: function setActiveBlock(guid) {
      this.resetActiveBlock();
      var block = this.getByGuid(guid);
    ...
    key: "setActiveTab",
    value: function setActiveTab(blockGuid, guid) {
      var block = this.getByGuid(blockGuid);
    ...
    key: "addRef",
    value: function addRef(guid, ref) {
      this.refs.push({
        guid: guid,
        element: ref
      });
    ...
    key: "getRefByGuid",
    value: function getRefByGuid(guid) {
      var element = this.refs.find(function (item) {
        return item.guid === guid;
      });
    ...
    key: "getStickyLines",
    value: function getStickyLines(guid) {
      var _this$getByGuid,
          _this2 = this;

      var blocks = guid ? (_this$getByGuid = this.getByGuid(guid)) === null || _this$getByGuid === void 0 ? void 0 : _this$getByGuid.children : this.blocks;
      ...
      blocks.filter(function (item) {
        ...
        if (!((_item$stickyTo2 = item.stickyTo) !== null && _item$stickyTo2 !== void 0 && _item$stickyTo2.guid)) {
          return false;
        }

        var stickyElm = _this2.getRefByGuid(item.stickyTo.guid);

        var elm = _this2.getRefByGuid(item.guid);

        if (!elm || !stickyElm) {
          return false;
        }

        if (item.stickyTo.type === StickyTo["a" /* StickyToType */].TOP) {
          answer.push({
            x1: "calc(".concat(elm.positionStyle.left, " + calc(").concat(elm.positionStyle.width, " / 2))"),
            y1: elm.positionStyle.top,
            x2: "calc(".concat(stickyElm.positionStyle.left, " + calc(").concat(stickyElm.positionStyle.width, " / 2))"),
            y2: "calc(".concat(stickyElm.positionStyle.top, " + ").concat(stickyElm.positionStyle.height, ")")
          });
        } else if (item.stickyTo.type === StickyTo["a" /* StickyToType */].LEFT) {
          answer.push({
            x1: elm.positionStyle.left,
            y1: "calc(".concat(elm.positionStyle.top, " + calc(").concat(elm.positionStyle.height, " / 2))"),
            x2: "calc(".concat(stickyElm.positionStyle.left, " + ").concat(stickyElm.positionStyle.width, ")"),
            y2: "calc(".concat(stickyElm.positionStyle.top, " + calc(").concat(stickyElm.positionStyle.height, " / 2))")
          });
        }
      });
      return answer;
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7e8adf26-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/previewer.vue?vue&type=template&id=be95e70a&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},_vm._l((_vm._blocks),function(block){return _c('preview-block',{key:block.guid,ref:block.guid,refInFor:true,attrs:{"block":block},scopedSlots:_vm._u([_vm._l((_vm.$scopedSlots),function(index,name){return {key:name,fn:function(data){return [_vm._t(name,null,null,data)]}}})],null,true)})}),1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/previewer.vue?vue&type=template&id=be95e70a&scoped=true&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7e8adf26-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/infrastructure/components/PreviewBlock.vue?vue&type=template&id=249f665a&scoped=true&
var PreviewBlockvue_type_template_id_249f665a_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"draggableContainer",staticClass:"block",style:(_vm.positionStyle)},[(_vm.isTabsContainer)?_c('div',{class:{
        'tabs_container' : true,
...
// EXTERNAL MODULE: ./src/application/service/BlockManager.ts + 4 modules
...
/* harmony default export */ var PreviewBlockvue_type_script_lang_ts_ = (Vue.extend({
          ...
          if (this.block.parentGuid) {
            if (typeof this.parentBlock !== 'undefined') {
              if (this.parentBlock.isStretched) {
                var parentSizes = BlockManager["a" /* default */].getAbsoluteSizesByParent(this.parentBlock, this.parentElement);

                if (this.block.sizeTypes.top === SizeTypes["a" /* SizeTypes */].PERCENT) {
                  top = "".concat(parentSizes.height / 100 * (this.block.top || 0), "px");
                  height = "".concat(parentSizes.height / 100 * this.block.height, "px");
                }

                if (this.block.sizeTypes.left === SizeTypes["a" /* SizeTypes */].PERCENT) {
                  left = "".concat(parentSizes.width / 100 * (this.block.left || 0), "px");
                  width = "".concat(parentSizes.width / 100 * this.block.width, "px");
                }
              }
            }
          }
  ...
  watch: {
    activeTabGuid: function activeTabGuid() {
      var _this2 = this;

      this.scrollHeight = 0;
      this.scrollWidth = 0;
      this.$nextTick(function () {
        _this2.scrollHeight = _this2.$el.getElementsByClassName('content')[0].scrollHeight;
        _this2.scrollWidth = _this2.$el.getElementsByClassName('content')[0].scrollWidth;
      });
    }
  },
  data: function data() {
  ...
  methods: {
    prepareReplication: function prepareReplication() {
      var _this$block$replicati, _this$block$replicati2, _me$block$replication;

      if (!((_this$block$replicati = this.block.replication) !== null && _this$block$replicati !== void 0 && _this$block$replicati.function)) {
        return;
      }

      var blocksData = (_this$block$replicati2 = this.block.replication) === null || _this$block$replicati2 === void 0 ? void 0 : _this$block$replicati2.function();
      blocksData.shift();
      var me = this;
      var lastGuid = me.block.guid;
      var lastRowGuid = me.block.guid;
      var lastRowTop = me.block.top;
      var columns = ((_me$block$replication = me.block.replication) === null || _me$block$replication === void 0 ? void 0 : _me$block$replication.columns) || 1;
      blocksData.forEach(function (item, index) {
        var newBlock = JSON.parse(JSON.stringify(me.block));
        ...
        if ((index + 1) % columns !== 0) {
          ...
          newBlock.left = ((_me$block$replication2 = me.block.replication) === null || _me$block$replication2 === void 0 ? void 0 : _me$block$replication2.horizontalMargin) || 0;
          ...
          var _me$block$replication3;

          newBlock.top = ((_me$block$replication3 = me.block.replication) === null || _me$block$replication3 === void 0 ? void 0 : _me$block$replication3.verticalMargin) || 0;
          newBlock.stickyTo = {
            type: 'top',
            guid: lastRowGuid
          };
...
// EXTERNAL MODULE: ./src/infrastructure/components/PreviewBlock.vue?vue&type=style&index=0&id=249f665a&scoped=true&lang=css&
var PreviewBlockvue_type_style_index_0_id_249f665a_scoped_true_lang_css_ = __webpack_require__("a202");
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  PreviewBlockvue_type_template_id_249f665a_scoped_true_render,
  PreviewBlockvue_type_template_id_249f665a_scoped_true_staticRenderFns,
  false,
  null,
  "249f665a",
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--14-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/ts-loader??ref--14-3!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/previewer.vue?vue&type=script&lang=ts&
 // eslint-disable-next-line no-unused-vars



var previewervue_type_script_lang_ts_Vue = external_commonjs_vue_commonjs2_vue_root_Vue_default.a;
/* harmony default export */ var previewervue_type_script_lang_ts_ = (previewervue_type_script_lang_ts_Vue.extend({
...
// CONCATENATED MODULE: ./src/previewer.vue?vue&type=script&lang=ts&
 /* harmony default export */ var src_previewervue_type_script_lang_ts_ = (previewervue_type_script_lang_ts_); 
// EXTERNAL MODULE: ./src/previewer.vue?vue&type=style&index=0&id=be95e70a&scoped=true&lang=css&
var previewervue_type_style_index_0_id_be95e70a_scoped_true_lang_css_ = __webpack_require__("4772");
...
var previewer_component = Object(componentNormalizer["a" /* default */])(
  src_previewervue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var previewer = __webpack_exports__["a"] = (previewer_component.exports);
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_previewer_vue_vue_type_style_index_0_id_be95e70a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("53de");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_previewer_vue_vue_type_style_index_0_id_be95e70a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_previewer_vue_vue_type_style_index_0_id_be95e70a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_25163348_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("ae0d");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_25163348_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_25163348_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SizeTypes; });
var SizeTypes;
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Block_vue_vue_type_style_index_0_id_8fb5994e_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("04c2");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Block_vue_vue_type_style_index_0_id_8fb5994e_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Block_vue_vue_type_style_index_0_id_8fb5994e_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7e8adf26-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/index.vue?vue&type=template&id=25163348&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_c('svg',{attrs:{"id":"svg"}},_vm._l((_vm.stickyLines),function(line,index){return _c('line',{key:index,staticClass:"line",attrs:{"x1":line.x1,"y1":line.y1,"x2":line.x2,"y2":line.y2}})}),0),_vm._l((_vm._blocks),function(block){return _c('block',{key:block.guid,ref:block.guid,refInFor:true,attrs:{"block":block,"step":_vm.step},on:{"start-drag":function($event){return _vm.$emit('start-drag', $event)},"stop-drag":function($event){return _vm.$emit('stop-drag', $event)},"dragging":function($event){return _vm.$emit('dragging', $event)},"contextmenu":function($event){return _vm.$emit('contextmenu', $event)}},scopedSlots:_vm._u([_vm._l((_vm.$scopedSlots),function(index,name){return {key:name,fn:function(data){return [_vm._t(name,null,null,data)]}}})],null,true)})})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/index.vue?vue&type=template&id=25163348&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7e8adf26-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/infrastructure/components/Block.vue?vue&type=template&id=8fb5994e&scoped=true&
var Blockvue_type_template_id_8fb5994e_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"draggableContainer",class:{
      'block': true,
      'highlight' : _vm.isResizing || _vm.isDragging,
      'active': _vm.block.isActive,
      'active_parent': _vm.block.isActiveAsParent },style:(_vm.positionStyle),on:{"mousedown":function($event){$event.stopPropagation();return _vm.dragStart($event)},"contextmenu":function($event){$event.stopPropagation();return _vm.$emit('contextmenu', {block: _vm.block, event: $event})}}},[(_vm.isTabsContainer)?_c('div',{class:{
        'tabs_container' : true,
        'position_top': _vm.block.tabs.position === 'top',
        'position_right': _vm.block.tabs.position === 'right',
        'position_bottom': _vm.block.tabs.position === 'bottom',
      ...
      var _obj;
return _c('div',{key:tab.guid,class:( _obj = {'tab': true, 'active': tab.guid === _vm.activeTabGuid}, _obj[_vm.block.tabs.class] = true, _obj ),style:(((_vm.block.tabs.tabStyle) + ";" + (tab.guid === _vm.activeTabGuid ? _vm.block.tabs.activeTabStyle :''))),on:{"click":function($event){return _vm.onTabClick(tab.guid)}}},[_c('span',{staticClass:"label"},[_vm._v(_vm._s(tab.name))])])}),0):_vm._e(),_c('div',{staticClass:"block_info"},[_vm._t("help_text",null,{"block":_vm.block})],2),_vm._t("info",[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.isResizing),expression:"isResizing"}],staticClass:"block_info"},[_vm._v(" "+_vm._s(_vm.block.width)+_vm._s(_vm.block.sizeTypes.width)+" x "+_vm._s(_vm.block.height)+_vm._s(_vm.block.sizeTypes.height)+" ")]),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.isDragging),expression:"isDragging"}],staticClass:"position_line left",style:(("left: calc(-" + (_vm.currentPosition.left) + "px - 1px);width:calc(" + (_vm.currentPosition.left) + "px - 1px)"))},[_c('span',[_vm._v(_vm._s(_vm.block.left)+_vm._s(_vm.block.sizeTypes.left))])]),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.isDragging),expression:"isDragging"}],staticClass:"position_line top",style:(("top: -" + (_vm.currentPosition.top) + "px;height:" + (_vm.currentPosition.top) + "px"))},[_c('span',[_vm._v(_vm._s(_vm.block.top)+_vm._s(_vm.block.sizeTypes.top))])])],{"block":_vm.block,"isResizing":_vm.isResizing,"isDragging":_vm.isDragging}),_c('div',{staticClass:"content",style:(_vm.block.style)},[(!_vm.isTabsContainer)?_vm._t("content",null,{"block":_vm.block}):_vm._e(),_c('svg',{attrs:{"id":"svg"}},_vm._l((_vm.stickyLines),function(line,index){return _c('line',{key:index,staticClass:"line",attrs:{"x1":line.x1,"y1":line.y1,"x2":line.x2,"y2":line.y2}})}),0),_vm._l((_vm.block.children),function(_block){return _c('block',{directives:[{name:"show",rawName:"v-show",value:(!(_vm.block.tabs || {}).use || _block.parentTabGuid === _vm.activeTabGuid),expression:"!(block.tabs || {}).use || _block.parentTabGuid === activeTabGuid"}],key:_block.guid,ref:_block.guid,refInFor:true,attrs:{"block":_block,"step":_vm.step},on:{"start-drag":function($event){return _vm.$emit('start-drag', $event)},"stop-drag":function($event){return _vm.$emit('stop-drag', $event)},"dragging":function($event){return _vm.$emit('dragging', $event)},"contextmenu":function($event){return _vm.$emit('contextmenu', $event)}},scopedSlots:_vm._u([_vm._l((_vm.$scopedSlots),function(index,name){return {key:name,fn:function(data){return [_vm._t(name,null,null,data)]}}})],null,true)})})],2),_c('font-awesome-icon',{staticClass:"resize-handler",attrs:{"icon":"angle-down"},on:{"mousedown":function($event){$event.stopPropagation();return _vm.resizeStart($event)}}})],2)}
var Blockvue_type_template_id_8fb5994e_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./src/infrastructure/components/Block.vue?vue&type=template&id=8fb5994e&scoped=true&
...
var Vue = external_commonjs_vue_commonjs2_vue_root_Vue_default.a;
fontawesome_svg_core_index_es["c" /* library */].add(faAngleDown);
/* harmony default export */ var Blockvue_type_script_lang_ts_ = (Vue.extend({
  ...
  watch: {
    'block.stickyTo.guid': {
      handler: function handler(value, oldValue) {
        var _this$block$stickyTo3, _this$block$stickyTo4, _this$block$stickyTo5, _this$block$stickyTo6;
        ...
        if (oldValue && !value) {
          ...
          if (((_this$block$stickyTo = this.block.stickyTo) === null || _this$block$stickyTo === void 0 ? void 0 : _this$block$stickyTo.type) === StickyTo["a" /* StickyToType */].TOP) {
            ...
            this.block.left = Math.abs((this.block.left || 0) + _difference);
          }

          return;
        }

        if (!value || !((_this$block$stickyTo3 = this.block.stickyTo) !== null && _this$block$stickyTo3 !== void 0 && _this$block$stickyTo3.guid)) {
          return;
        }

        var el = this.getStore().getRefByGuid((_this$block$stickyTo4 = this.block.stickyTo) === null || _this$block$stickyTo4 === void 0 ? void 0 : _this$block$stickyTo4.guid);

        if (((_this$block$stickyTo5 = this.block.stickyTo) === null || _this$block$stickyTo5 === void 0 ? void 0 : _this$block$stickyTo5.type) === StickyTo["a" /* StickyToType */].TOP) {
          ...
          this.block.top = Math.abs((this.block.top || 0) - _difference2);
        } else if (((_this$block$stickyTo6 = this.block.stickyTo) === null || _this$block$stickyTo6 === void 0 ? void 0 : _this$block$stickyTo6.type) === StickyTo["a" /* StickyToType */].LEFT) {
          ...
          this.block.left = Math.abs((this.block.left || 0) - _difference3);
        }
      }
    },
    ...
    'block.tabs.list': {
      handler: function handler() {
        ...
        if (!((_this$block$tabs = this.block.tabs) !== null && _this$block$tabs !== void 0 && _this$block$tabs.list.find(function (item) {
          return item.guid === _this.activeTabGuid;
        }))) {
  ...
  computed: {
    ...
    positionStyle: function positionStyle() {
      ...
      if ((_this$block$stickyTo7 = this.block.stickyTo) !== null && _this$block$stickyTo7 !== void 0 && _this$block$stickyTo7.guid && (_this$block$stickyTo8 = this.block.stickyTo) !== null && _this$block$stickyTo8 !== void 0 && _this$block$stickyTo8.type) {
        var stickyToBlock = this.getStore().getByGuid(this.block.stickyTo.guid);
        var stickyToElement = this.getStore().getRefByGuid(this.block.stickyTo.guid);
  ...
  mounted: function mounted() {
    var _this$block, _this$block$tabs6, _this$block2, _this$block2$tabs, _this$block2$tabs$lis;
...
// EXTERNAL MODULE: ./src/infrastructure/components/Block.vue?vue&type=style&index=0&id=8fb5994e&scoped=true&lang=css&
var Blockvue_type_style_index_0_id_8fb5994e_scoped_true_lang_css_ = __webpack_require__("9863");
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  Blockvue_type_template_id_8fb5994e_scoped_true_render,
  Blockvue_type_template_id_8fb5994e_scoped_true_staticRenderFns,
  false,
  null,
  "8fb5994e",
  null
...
// EXTERNAL MODULE: ./src/index.vue?vue&type=style&index=0&id=25163348&scoped=true&lang=css&
var srcvue_type_style_index_0_id_25163348_scoped_true_lang_css_ = __webpack_require__("8ef6");
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PreviewBlock_vue_vue_type_style_index_0_id_249f665a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("d580");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PreviewBlock_vue_vue_type_style_index_0_id_249f665a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PreviewBlock_vue_vue_type_style_index_0_id_249f665a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
...
var CustomDomRect_CustomDomRect = /*#__PURE__*/function () {
  function CustomDomRect() {
    Object(classCallCheck["a" /* default */])(this, CustomDomRect);
  ...
  Object(createClass["a" /* default */])(CustomDomRect, null, [{
    key: "fromDocRect",
    value: function fromDocRect(domRect) {
      var top = domRect.top,
          right = domRect.right,
...
var _MAP, _Breakpoints$X, _Breakpoints$Y, _STICKY_OFFSET_MAP;



var MAP = (_MAP = {}, _defineProperty(_MAP, Breakpoints.W, {
  client: 'clientX',
  movement: 'movementX',
  offset: 'width',
  size: 'width',
  inverse: false
}), _defineProperty(_MAP, Breakpoints.H, {
  client: 'clientY',
  movement: 'movementY',
  offset: 'height',
  size: 'height',
  inverse: false
}), _defineProperty(_MAP, Breakpoints.Y, {
  client: 'clientY',
  movement: 'movementY',
  size: 'height',
  offset: 'top',
  inverse: false
}), _defineProperty(_MAP, Breakpoints.X, {
  client: 'clientX',
  movement: 'movementX',
  size: 'width',
  offset: 'left',
...
var STICKY_OFFSET_MAP = (_STICKY_OFFSET_MAP = {}, _defineProperty(_STICKY_OFFSET_MAP, Breakpoints.X, (_Breakpoints$X = {}, _defineProperty(_Breakpoints$X, Sticky["a" /* Sticky */].TR, {
  offset: 'right',
  inverse: true
}), _defineProperty(_Breakpoints$X, Sticky["a" /* Sticky */].TL, {
  offset: 'left',
  inverse: false
}), _defineProperty(_Breakpoints$X, Sticky["a" /* Sticky */].BL, {
  offset: 'left',
  inverse: false
}), _defineProperty(_Breakpoints$X, Sticky["a" /* Sticky */].BR, {
  offset: 'right',
  inverse: true
}), _Breakpoints$X)), _defineProperty(_STICKY_OFFSET_MAP, Breakpoints.Y, (_Breakpoints$Y = {}, _defineProperty(_Breakpoints$Y, Sticky["a" /* Sticky */].TR, {
  offset: 'top',
  inverse: false
}), _defineProperty(_Breakpoints$Y, Sticky["a" /* Sticky */].TL, {
  offset: 'top',
  inverse: false
}), _defineProperty(_Breakpoints$Y, Sticky["a" /* Sticky */].BL, {
  offset: 'bottom',
  inverse: true
}), _defineProperty(_Breakpoints$Y, Sticky["a" /* Sticky */].BR, {
  offset: 'bottom',
  inverse: true
}), _Breakpoints$Y)), _STICKY_OFFSET_MAP);

var BreakpointsFactory_BreakpointsFactory = /*#__PURE__*/function () {
  function BreakpointsFactory() {
    Object(classCallCheck["a" /* default */])(this, BreakpointsFactory);
  }

  Object(createClass["a" /* default */])(BreakpointsFactory, null, [{
    key: "build",
    value: function build(type, sticky) {
      var options = (STICKY_OFFSET_MAP[type] || {})[sticky] || null;
...
var BlockManager_BlockManager = /*#__PURE__*/function () {
  function BlockManager(block, repository, blockElement) {
    var step = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0.5;

    Object(classCallCheck["a" /* default */])(this, BlockManager);
    ...
    this.movementY = 0;
    this.type = 'drag';
    this.blockElementRect = new CustomDomRect_CustomDomRect();
  ...
  Object(createClass["a" /* default */])(BlockManager, [{
    key: "startDrag",
    value: function startDrag(event, type) {
      ...
      if (this.type === 'drag' && isInteractive) {
        ...
        if ((_this$block$stickyTo = this.block.stickyTo) !== null && _this$block$stickyTo !== void 0 && _this$block$stickyTo.guid) {
          ...
          var el = this.repository.getRefByGuid((_this$block$stickyTo2 = this.block.stickyTo) === null || _this$block$stickyTo2 === void 0 ? void 0 : _this$block$stickyTo2.guid);
    ...
    value: function getBlockElementRect() {
      var blockRect = CustomDomRect_CustomDomRect.fromDocRect(this.blockElement.getBoundingClientRect());

      if (!this.parentElement) {
        return blockRect;
      }

      var parentElementRect = this.parentElement.getBoundingClientRect();
    ...
    key: "setYPosition",
    value: function setYPosition(event) {
      var breakpoints = BreakpointsFactory_BreakpointsFactory.build(Breakpoints.Y, this.block.sticky);
    ...
    key: "setXPosition",
    value: function setXPosition(event) {
      var breakpoints = BreakpointsFactory_BreakpointsFactory.build(Breakpoints.X, this.block.sticky);
    ...
    value: function setRelativePosition(type) {
      ...
      var parentElementPositions = this.parentElement.getBoundingClientRect();
      var currentPosition;
      ...
      if ((_this$block$stickyTo5 = this.block.stickyTo) !== null && _this$block$stickyTo5 !== void 0 && _this$block$stickyTo5.guid && (type === Breakpoints.Y || type === Breakpoints.X)) {
        ...
        var el = this.repository.getRefByGuid((_this$block$stickyTo6 = this.block.stickyTo) === null || _this$block$stickyTo6 === void 0 ? void 0 : _this$block$stickyTo6.guid);
    ...
    value: function getNewRelativeSize(type, currentRelativeSize) {
      var size = Math.floor(currentRelativeSize / this.step) * this.step;
    ...
    key: "getAbsoluteSizesByParent",
    value: function getAbsoluteSizesByParent(block, blockElement) {
      var blockRect = new CustomDomRect_CustomDomRect();
      var parentElement = blockElement.parentElement;
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "a", function() { return /* binding */ BlockDTO_BlockDTO; });
...
// CONCATENATED MODULE: ./src/domain/model/TabProperties.ts
var TabPosition;
...
// CONCATENATED MODULE: ./src/domain/model/BlockDTO.ts
...
var BlockDTO_BlockDTO = /*#__PURE__*/function () {
  function BlockDTO(_ref) {
    var _ref$children = _ref.children,
      ...
      left: SizeTypes["a" /* SizeTypes */].PERCENT
        ...
        stickyTo = _ref.stickyTo,
        replication = _ref.replication;

    Object(classCallCheck["a" /* default */])(this, BlockDTO);

    this.isStretched = false;
    this.isActive = false;
    this.isActiveAsParent = false;
    this.tabs = {
      use: false,
      list: [],
    ...
    var _BlockDTO$getPrepared = BlockDTO.getPreparedSizes({
      ...
      sticky: sticky
        ...
        _top = _BlockDTO$getPrepared._top,
        _right = _BlockDTO$getPrepared._right,
        _bottom = _BlockDTO$getPrepared._bottom,
        _left = _BlockDTO$getPrepared._left;
  ...
  Object(createClass["a" /* default */])(BlockDTO, null, [{
    key: "getPreparedSizes",
    value: function getPreparedSizes(_ref2) {
      var top = _ref2.top,
          right = _ref2.right,
          bottom = _ref2.bottom,
          left = _ref2.left,
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "install", function() { return /* reexport */ src_0["d" /* install */]; });
__webpack_require__.d(__webpack_exports__, "VueDraggableResponsiveDesigner", function() { return /* reexport */ src_0["a" /* VueDraggableResponsiveDesigner */]; });
__webpack_require__.d(__webpack_exports__, "VueDraggableResponsivePreviewer", function() { return /* reexport */ src_0["b" /* VueDraggableResponsivePreviewer */]; });
...
//# sourceMappingURL=vue-draggable-responsive.umd.js.map